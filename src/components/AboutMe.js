...
export default function AboutMe() {
  ...
  return (
    <div className="bg-neutral card shadow-xl">
      <div className="card-body">
        {/* overflow-auto  max-h-[50rem] this is for scroll bar */}
        <div className="pb-5">
          <h1 className="text-primary-content text-3xl font-bold">About Me</h1>
          <p className="text-xl">
        ...
        <div className="pb-5">
          <h2 className="text-primary-content text-3xl font-bold">What I Do</h2>
          <p className="text-xl">
            I specialize in Single Page Applications in React creating websites
            that do not have to send multiple server requests to load.{" "}
          </p>
        </div>
        <div className="grid grid-cols-12 gap-4 pb-5">
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            <p className="text-xl">
              Leveraging front-end frameworks that implement mobile first design
              to create a beautiful UI/UX on the web.{" "}
            </p>
          </div>
          <div className="col-span-12 md:col-span-6">
            <h2 className="text-primary-content text-xl">
        ...
        <div class="grid grid-cols-12 justify-items-center gap-4 flex-wrap">
          <div className="col-span-6 md:col-span-3 pb-5">
              <img className="w-4/6 md:w-1/2 mx-auto pb-3" src={cImage} alt="react img" />
              <p className="text-center">C</p>
          </div>
          <div className="col-span-6 md:col-span-3 pb-5">
            <img className="w-4/6 md:w-1/2 mx-auto pb-3" src={nodeImage} alt="react img" />
            <p className="text-center">Node.js</p>
          </div>
          <div className="col-span-6 md:col-span-3 pb-5">
            <img className="w-4/6 md:w-1/2 mx-auto pb-3" src={restAPI} alt="react img" />
            <p className="text-center">Rest APIs</p>
          </div>
          <div className="col-span-6 md:col-span-3 pb-5">
            <img className="w-4/6 md:w-1/2 mx-auto pb-3" src={gitHub} alt="react img" />
